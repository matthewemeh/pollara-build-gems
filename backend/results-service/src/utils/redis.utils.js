...
/**
 * @param {Array<string | number>} values unique values to be used in key. The order of the arguments affects the key!!!
 * @returns {string} election results key in a standard pattern
 */
const getElectionResultsKey = (...values) => `election-results:${values.join(':')}`;

/**
 * @param {Array<string | number>} values unique values to be used in key. The order of the arguments affects the key!!!
 * @returns {string} form results key in a standard pattern
 */
const getFormResultsKey = (...values) => `form-results:${values.join(':')}`;

/**
 * @param {Array<string | number>} values unique values to be used in key. The order of the arguments affects the key!!!
 * @returns {string} election result key in a standard pattern
 */
const getElectionResultKey = (...values) => `election-result:${values.join(':')}`;

/**
 * @param {Array<string | number>} values unique values to be used in key. The order of the arguments affects the key!!!
 * @returns {string} form result key in a standard pattern
 */
const getFormResultKey = (...values) => `form-result:${values.join(':')}`;
